...
var printTextarea = (function() {
    ...
    return function(text) {
        ...
        try {
            if (typeof window !== 'undefined' && typeof window.handleWhisperOutputLine === 'function') {
                String(text).split(/\r?\n/).forEach(function(line) {
                    if (line.trim()) window.handleWhisperOutputLine(line);
                });
            }
        } catch (err) {
            console.warn('handleWhisperOutputLine failed:', err);
        }
    };
})();
